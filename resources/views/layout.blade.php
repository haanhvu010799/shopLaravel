            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" class="pull-left" style="width: 70%"  name="keywords_submit" id="keywords" placeholder="Tìm kiếm sản phẩm"/>
                        <div id="search-ajax"></div>
                     
                    
                        <input type="submit" style="margin-top:0;width: 30% ;color:white;" name="search_items" class="pull-right btn btn-primary btn-sm " value="Tìm kiếm">
    ...
    $(document).ready(function(){
        $('.add-to-cart').click(function(){
            ...
            if(parseInt(cart_product_qty)>parseInt(cart_product_quantity)){
                alert('Số lượng phải ít hơn ' + cart_product_quantity);
            }else{
